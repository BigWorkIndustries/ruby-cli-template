...
require "console/util/version"

Gem::Specification.new do |spec|
  spec.name          = "console-util"
  spec.license       = "MIT"
  spec.version       = Console::Util::VERSION
  spec.authors       = ["Vincil Bishop"]
  spec.email         = ["vincil.bishop@vbishop.com"]

  spec.summary       = %q{Console Summary}
  spec.description   = %q{Console Description}
  spec.homepage      = "https://github.com/BigWorkIndustries/ruby-cli-template"
